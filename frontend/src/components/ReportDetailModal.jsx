      ...
      <div className="bg-slate-950 border border-slate-700 rounded-3xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden">
        ...
        <div className="p-6 overflow-y-auto space-y-6">
          ...
          <div>
            ...
            <div className="p-4.5 rounded-2xl bg-amber-950/30/50 border border-slate-800 text-xs text-slate-200 leading-relaxed font-medium">
              ...
              <div className="bg-slate-900 border border-slate-700 rounded-xl p-4 text-xs shadow-none">
                <div className="flex justify-between items-start mb-2">
                  <div>
                    ...
                    <span className="text-slate-500 font-medium">Decision: <strong className="text-slate-200">{incident.review_status.toUpperCase()}</strong></span>
                  </div>
                  {incident.reviewer_override_category && (
                    <span className="px-2 py-1 bg-rose-900/40 text-rose-400 border border-rose-200 rounded font-bold text-[10px] uppercase">
                ...
                {incident.exemplar_created_id && (
                  <p className="text-[10px] text-slate-500 font-mono font-bold mt-3 border-t border-slate-800 pt-2">
